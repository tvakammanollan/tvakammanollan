      ...
      >
        <section className="mb-10">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <Link
              to="/guider/ord"
              className="group block rounded-2xl border p-5 transition-all hover:border-primary/50 hover:shadow-[0_0_16px_rgba(174,47,38,0.12)]"
          ...
          <div className="mb-4 flex flex-wrap gap-2">
            {["ord", "mek", "las", "elf", "xyz", "kva", "nog", "dtk"].map((s) => (
              <Link
                ...
                to="/ova/$delprov"
                params={{ delprov: s }}
                className="rounded-full border px-3.5 py-1.5 text-sm font-medium transition-colors hover:border-primary/50 hover:text-primary"
