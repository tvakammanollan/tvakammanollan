        ...
        jsonLdScript({
          ...
          mainEntity: {
            ...
            itemListElement: threads.map((t, i) => ({
              ...
              name: t.title,
              url: `https://hpkampen.se${threadPath(t.categorySlug, t.id, t.slug)}`,
            })),
          },
        }),
      ],
    ...
    <div className="mx-auto max-w-4xl px-4 pb-24 pt-10 sm:px-6">
      ...
      <header className="mt-4 flex flex-wrap items-end justify-between gap-4">
        ...
        <Link
          ...
          className="inline-flex shrink-0 items-center gap-2 rounded-xl bg-[var(--amber)] px-4 py-2 text-sm font-semibold text-[#170d05] transition-opacity hover:opacity-90"
        >
