...
export function ResumeMatchBanner() {
  ...
  return (
    <div className="mb-4 flex flex-col items-start gap-2 rounded-xl border border-[#eab308]/40 bg-[#fefce8] px-4 py-3 text-sm sm:flex-row sm:items-center sm:justify-between">
