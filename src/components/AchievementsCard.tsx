        ...
        <div className="mt-3 flex flex-wrap gap-2">
          {unlocked.slice(0, 8).map((a) => (
            <span
              ...
              className="flex h-10 w-10 items-center justify-center rounded-xl bg-primary/10 ring-1"
  ...
  return (
    <div>
      <div className="mb-4 flex items-baseline justify-between">
        <h2
          className="relative pb-2 text-xl font-semibold after:absolute after:bottom-0 after:left-0 after:h-[2px] after:w-10 after:bg-primary"
        ...
        {items.map((a) => (
          <div
            ...
            className={`relative overflow-hidden rounded-xl border p-3.5 transition-colors ${
              a.unlocked ? "border-primary/30 bg-primary/[0.06]" : "border-border bg-card"
            }`}
          >
            <div className="flex items-start gap-3">
              <span
                className={`flex h-11 w-11 shrink-0 items-center justify-center rounded-xl ring-1 ${
                  a.unlocked ? "bg-primary/10" : "bg-white/[0.03] ring-white/10"
                }`}
                style={
                  a.unlocked
