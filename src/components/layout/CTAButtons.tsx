...
const primaryClass =
  "inline-flex h-[52px] items-center justify-center gap-2 rounded-md bg-[#f2a65a] px-7 text-[15px] font-semibold text-[#1a0d04] " +
  "shadow-[0_0_28px_rgba(242,166,90,0.28)] transition-all hover:bg-[#f2a65a]/90 hover:shadow-[0_0_36px_rgba(242,166,90,0.40)] " +
