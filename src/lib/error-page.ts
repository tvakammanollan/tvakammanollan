...
<html lang="sv">
  <head>
    ...
    <style>
      ...
      .primary { background: #ae2f26; color: #0A0A0F; }
      .secondary { background: transparent; color: #F5E9D6; border-color: rgba(245, 233, 214, 0.2); }
      .badge { display: inline-block; padding: 0.25rem 0.75rem; border-radius: 9999px; background: rgba(174, 47, 38, 0.15); color: #ae2f26; font-size: 0.75rem; font-weight: 600; letter-spacing: 0.05em; text-transform: uppercase; margin-bottom: 1rem; }
    </style>
  </head>
  <body>
    <div class="card">
